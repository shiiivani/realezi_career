...
mm.add("(min-width: 1200px) and (max-height: 900px)", function () {
  ...
  rocketTimelineLarge
    ...
    .to(".rocket", { duration: 0.05, x: 390, y: 1300, rotation: 0 })
    .to(".rocket", { duration: 0.05, y: 1500, rotation: 0 });
});
...
//     .to(".rocket", { duration: 0.2, x: 386, y: 1300, rotation: 0 })
...
mm.add("(min-width: 1200px) and (min-height: 1000px)", function () {
  ...
  rocketTimelineLarge
    ...
    .to(".rocket", { duration: 0.1, y: 900, rotation: -55 })
    .to(".rocket", { duration: 0.1, x: 380, y: 1300, rotation: -55 })
    .to(".rocket", { duration: 0.1, y: 1400, rotation: 0 })
    .to(".rocket", { duration: 0.2, x: 385, y: 1500, rotation: 0 })
    .to(".rocket", { duration: 0.1, y: 1640, rotation: 0 });
});
...
mm.add("(min-width: 990px) and (max-width: 1100px)", function () {
  ...
  rocketTimelineLarge
    ...
    .to(".rocket", { duration: 0.2, y: 1710, rotation: 0 });
});
